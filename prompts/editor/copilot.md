# GitHub Copilot (VS Code) - build a Tagembed social wall
...
```
Build the Tagembed social wall described in .github/copilot-instructions.md and llms.txt in this folder. Use PHP 8: one self-contained index.php, nothing to install.
...
```
Build the Tagembed social wall described in .github/copilot-instructions.md and llms.txt in this folder. Use Node.js 18+ with Express: server.js and package.json.
Don't ask me anything; create the files, then tell me how to run it as if I've never used a terminal.
```
