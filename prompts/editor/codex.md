# OpenAI Codex CLI - build a Tagembed social widget
...
curl -sSLo AGENTS.md https://raw.githubusercontent.com/wallapi/tagembed.com-API-Docs/main/prompts/TAGEMBED_CONTEXT.md
```
...
curl.exe -sSLo AGENTS.md https://raw.githubusercontent.com/wallapi/tagembed.com-API-Docs/main/prompts/TAGEMBED_CONTEXT.md
```
...
```
Build the Tagembed social widget described in AGENTS.md and llms.txt in this folder. First open the theme picker from the theme catalogue in my browser - the thumbnails page itself, not a list of names - and ask which theme I want; then ask which language I want the server code in (any: Python, PHP, Node.js, Go, ...). One question per reply, and start building on my second answer.
