# Prompt A, part 2 of 3 - server.js + package.json (when I picked Node.js)
...
stylesheet. Same CSS, markup and theme as preview.html from part 1. Read the base URL and token from the API_BASE_URL and
