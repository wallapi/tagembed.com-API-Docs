# claude.ai - build a Tagembed social wall
...
Use PHP 8: one self-contained index.php, nothing to install. Token comes from the TAGEMBED_ACCESS_TOKEN env var, so don't ask me for it.
