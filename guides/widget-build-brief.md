...
| [widget-design-spec.md](https://raw.githubusercontent.com/wallapi/tagembed.com-API-Docs/main/guides/widget-design-spec.md) | the looks: `--tbd-*` tokens, the shipped themes in themes.json, card treatment, REEL and WALL layouts, states |
