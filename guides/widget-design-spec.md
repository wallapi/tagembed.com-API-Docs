...
The design itself lives in [themes-lite.json](https://raw.githubusercontent.com/wallapi/tagembed.com-API-Docs/main/guides/themes-lite.json) beside this file — read
...
[themes-lite.json](https://raw.githubusercontent.com/wallapi/tagembed.com-API-Docs/main/guides/themes-lite.json), the catalogue Tagembed itself renders widgets with.
Read that file first; the palette further down is only what you fall back to
when you cannot.

### Themes — where the design comes from

[themes-lite.json](https://raw.githubusercontent.com/wallapi/tagembed.com-API-Docs/main/guides/themes-lite.json) is that catalogue as data: 23 themes (18 social, 5
review), each carrying the `style` fields mapped below, as the widget is really
rendered with them. Fetch it raw:

```
https://raw.githubusercontent.com/wallapi/tagembed.com-API-Docs/main/guides/themes-lite.json
```

The full export, with every app field, is [themes.json](https://raw.githubusercontent.com/wallapi/tagembed.com-API-Docs/main/guides/themes.json) —
