...
```bash
curl -s 'https://api.tagembed.com/api/v3/posts?media_types=image&sort=-created_at&limit=2' \
...
```js
const BASE = 'https://api.tagembed.com/api';
...
```php
<?php
$base = 'https://api.tagembed.com/api';
